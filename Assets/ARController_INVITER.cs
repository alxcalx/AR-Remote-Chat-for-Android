...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    /// </summary>
    public class ARController_INVITER : MonoBehaviour
    {
        ...
        public void Start()
        {
         ...
         .GetReference("sessions").Child(autoCompleteScroll.GetReceiverID()).Child(autoCompleteScroll.GetSessionID()).Child("invitee_animation")
    .ValueChanged += (object sender2, ValueChangedEventArgs e3) =>
    {
        ...
        anim.Play(e3.Snapshot.Value.ToString());
            ...
            FirebaseDatabase.DefaultInstance
                     .GetReference("sessions").Child(autoCompleteScroll.GetReceiverID()).Child(autoCompleteScroll.GetSessionID()).Child("invitee_message")
            ...
            FirebaseDatabase.DefaultInstance
           .GetReference("sessions").Child(autoCompleteScroll.GetReceiverID()).Child(autoCompleteScroll.GetSessionID()).Child("invitee_character")
              .ValueChanged += (object sender2, ValueChangedEventArgs e2) =>
              {
                  if (e2.DatabaseError != null)
                  {
                  ...
                  invitee_charcater = e2.Snapshot.Value.ToString();
                  Debug.Log(invitee_charcater);
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
                if (currentNumberOfObjects < numberOfObjectsAllowed)
                {
                    ...
                    else
                    {
                        ...
                        AndyObject = Instantiate(prefab.transform.Find(invitee_charcater).gameObject, hit.Pose.position, hit.Pose.rotation);
